...
Project instructions for CMC EDU v2 live in `AGENTS.md`, imported below. The
GitNexus code-intelligence guide is part of that file; it is intentionally not
duplicated here.
...
This project is indexed by GitNexus as **cmc_edu** (11525 symbols, 16801 relationships, 147 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
