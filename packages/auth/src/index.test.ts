...
const ACTIVE_ROLE_MATRIX: Array<{ key: string; allowed: readonly string[] }> = [
  ...
  { key: 'parentAccount.read', allowed: ['giam_doc_kinh_doanh', 'giam_doc_dao_tao', 'sale'] },
  ...
  // Both directors hold user.manage — staff provisioning/manage authority —
  // with super_admin escalation guards in the user router; the registry is
  // the authority (commit e917812) and this matrix must mirror it.
