...
describe('HighlightStrip', () => {
  it('renders labels and values', () => {
    ...
    expect(container.querySelector('.console-highlight')).toBeTruthy();
    expect(container.querySelector('.console-highlight-value--tabular')).toBeTruthy();
  });

  it('renders nothing when items empty', () => {
    const { container } = render(<HighlightStrip items={[]} />);
    expect(container.querySelector('.console-highlight')).toBeNull();
  });
});
