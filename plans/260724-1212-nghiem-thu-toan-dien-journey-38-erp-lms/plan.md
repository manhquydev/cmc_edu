...
| 7 | [Đợt HR/payroll + rewards/admin](./phase-07-dot-hr-rewards-admin.md) | **Một phần** — ADM-01/02/03/04/05 + P3-09 + P3-03/04/07(shift) + P3-05(payroll) + P4-03(họp PH) + P4-05(sau bán) xanh 4×; P3-10/11 no-ui-path; sổ **28/38** do CI chứng (P4-04 thêm +1; journey đó lộ 1 lỗi sản phẩm + 3 lỗi test đã sửa). Còn kpi-confirm(P3-06/08), P1-06 ([report](../reports/phase-07-part1-admin-260725-1920-report.md)) | 6 |
