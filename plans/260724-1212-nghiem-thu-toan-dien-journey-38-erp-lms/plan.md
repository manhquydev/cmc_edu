...
| 7 | [Đợt HR/payroll + rewards/admin](./phase-07-dot-hr-rewards-admin.md) | **Một phần** — ADM-01/02/03/04/05 + P3-09 xanh 4×; P3-10/11 no-ui-path; sổ **22/38**. Còn HR nặng (shift/payroll/kpi-confirm) + rewards (P4-03/04/05) ([report](../reports/phase-07-part1-admin-260725-1920-report.md)) | 6 |
