...
| 7 | [Đợt HR/payroll + rewards/admin](./phase-07-dot-hr-rewards-admin.md) | **Một phần** — ADM-01/02/03/04/05 + P3-09 + P3-03/04/07(shift) + P3-05 + P4-03 + P4-05 + P4-04 + P3-06/P3-08(KPI) xanh 4×; P3-10/11 no-ui-path; sổ **30/38** do CI chứng (commit 7af135a). Còn đúng **P1-06** là chạm trần 31/38 — công thức đã dò sẵn trong phase file ([report](../reports/phase-07-part1-admin-260725-1920-report.md)) | 6 |
