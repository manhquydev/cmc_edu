...
| 7 | [Đợt HR/payroll + rewards/admin](./phase-07-dot-hr-rewards-admin.md) | **Một phần** — ADM-01/02/03/04/05 + P3-09 + P3-03/04/07(shift) + P3-05(payroll) + P4-03(họp PH) + P4-05(sau bán) xanh 4×; P3-10/11 no-ui-path; sổ **27/38** (P3-05 đóng false-green; P4-03+P4-05 count-mover +2). Còn kpi-confirm(P3-06/08), P4-04(test đầu vào), P1-06 ([report](../reports/phase-07-part1-admin-260725-1920-report.md)) | 6 |
