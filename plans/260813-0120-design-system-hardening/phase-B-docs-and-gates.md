...
**Trạng thái:** xong — merged [#125](https://github.com/manhquydev/cmc_edu/pull/125) 2026-08-13 · **Công:** ~3–5h · **Branch:** `docs/console-authority`
...
- [x] `pnpm typecheck` xanh — PR #125 body 34/34; CI `typecheck-and-test` success trên PR (job 94313949881). Worktree cook lúc đầu đỏ Prisma cache, không nằm trong diff.
