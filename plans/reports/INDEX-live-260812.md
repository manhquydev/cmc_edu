...
**Design-lab bridge (2026-08-14):** D0–D5 (#142), Wave 4A + CRM/courses (#143), affordances/brand/students/CRM sort (#144) on `develop`. Live cook target: [`260814-2346-classes-listpage-empty-recipe-after-144/plan.md`](../260814-2346-classes-listpage-empty-recipe-after-144/plan.md) (Classes ListPage empty recipe). Authority: [`design-lab/system/BRIDGE.md`](../../design-lab/system/BRIDGE.md) + OpenEduCat visual contract. Prior wave plan `260814-2154` **completed** (#144).
